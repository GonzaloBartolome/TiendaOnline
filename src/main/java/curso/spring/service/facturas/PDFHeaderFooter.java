...
public class PDFHeaderFooter extends PdfPageEventHelper {
    ...
    public void onStartPage(PdfWriter writer, Document document) {
    	...
    	try {
	    	...
	    	//imagen
    		//Obtenemos la imagen
    		imagen = Image.getInstance("/Users/Newland/eclipse-spring/TiendaOnline_Gonzalo_Bartolome_Boya3/src/main/resources/static/img/logotype_dark.png");
	    	...
	    	//texto
    		//Agregamos un texto
    		txtCabecera = new Phrase("Factura Vinos Applause");
